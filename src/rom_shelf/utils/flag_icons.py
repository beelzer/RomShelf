...
class FlagIcons:
    ...
    REGION_TO_ISO: Dict[str, str] = {
        # Primary regions
        "USA": "us", "US": "us", "U": "us",
        "EUR": "eu", "Europe": "eu", "E": "eu",
        "JPN": "jp", "Japan": "jp", "J": "jp",
        "World": "world",
    ...
    REGION_TEXT: Dict[str, str] = {
        ...
        "EUR": "Europe", "Europe": "Europe", "E": "Europe",
        "JPN": "Japan", "Japan": "Japan", "J": "Japan",
        "World": "World",
        ...
        # Special regions
        "Asia": "Asia", "Prototype": "Prototype",
        "PAL": "PAL Region", "NTSC": "NTSC Region",

        # Multi-region combinations
        "USA/EUR": "USA/Europe", "USA/Europe": "USA/Europe",
        "USA/EUR/JPN": "USA/Europe/Japan",
        "JPN/USA": "Japan/USA", "Japan/USA": "Japan/USA",
        "USA/AUS": "USA/Australia", "USA/Australia": "USA/Australia",
        "EUR/AUS": "Europe/Australia", "Europe/Australia": "Europe/Australia",
        "USA/BRA": "USA/Brazil", "USA/Brazil": "USA/Brazil",
        "USA/EUR/BRA": "USA/Europe/Brazil", "USA/Europe/Brazil": "USA/Europe/Brazil",
        "USA/EUR/KOR": "USA/Europe/Korea", "USA/Europe/Korea": "USA/Europe/Korea",
    }
    ...
    @staticmethod
    def _load_svg_flag(iso_code: str, size: QSize) -> Optional[QIcon]:
    ...
    @staticmethod
    def create_flag_icon(region: str, size: QSize = QSize(16, 12)) -> Optional[QIcon]:
        """
    ...
    @staticmethod
    def _get_iso_code(region: str) -> Optional[str]:
    ...
    @staticmethod
    def _create_multi_region_flag(region: str, size: QSize) -> Optional[QIcon]:
    ...
    @staticmethod
    def get_flag_icon(region: str, size: QSize = QSize(16, 12)) -> Optional[QIcon]:
        """
